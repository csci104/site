...
A step by step visualization of how the Huffman tree is built is ![shown here](https://en.wikipedia.org/wiki/File:HuffmanCodeAlg.png)
...
<img src="{{site.url}}/assignments/img/huffman-ex1.png" alt="drawing" id="responsive-image"/>

#### Example 2

Here is how the Huffman codes would be generated using the string `i boo big bruins`.
<img src="{{site.url}}/assignments/img/huffman-ex2.png" alt="drawing" id="responsive-image"/>

...
1. a data type that stores all of the students waiting for office hour help, ordered by their place in line (an integer from 0 to n-1).  Given an integer, it brings up the student at that position.

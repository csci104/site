...
Homework will be assigned once every **2 weeks** roughly. It will be graded, and require substantial work. The average student should **expect to spend about 15-20 hours per homework**. Many Homework assignments will typically be split into two components: a written component and a coding component. Note: These components are submitted separately and have different late policies.
<!--

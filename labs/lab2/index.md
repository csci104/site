...
The files we'll be using for this lab are posted in the `sp24-labs` repository that you used last week. `cd` into where this repository is located for you in a Terminal window, and type `git pull` to get the lab 2 resources. After doing this, you should see a `lab2` folder pop up within your labs folder.

...
---
Congrats on finishing HW1! This lab is meant to help you for HW2 and get some more inheritance practice.

Lab resources live in the GitHub repository `sp2024-labs`; remember to get checked off by a CP/TA at the end.
...
<!-- ![inheritance](./assets/inheritance_diagram.png "Inheritance Diagram") -->
<!-- 
	Markdown syntax: ./assets/inheritance_diagram.png 
...
<img style="text-align:center" src="./assets/inheritance_diagram.png" alt="Inheritance diagram with different classes" width="500" height="400"/>
